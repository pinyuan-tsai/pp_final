...
//     //en_fp.write(reinterpret_cast<char *> (aes_block_array[i].block), blockLen);
...
fout.write(reinterpret_cast<char *> (aes_block_array), block_number*sizeof(class aes_block));
